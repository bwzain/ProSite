      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center space-y-3 mb-12">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-slate-900 dark:text-white">
            Let's Collaborate or <span className="text-sky-600 dark:text-sky-400">Connect</span>
          </h2>
          <p className="text-slate-700 dark:text-slate-300 text-base sm:text-lg max-w-2xl font-medium">
            Reach out for enterprise consulting, music production collaborations, or AI literature discussions.
          </p>
        </div>
